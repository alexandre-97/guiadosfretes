...
// ==================================================================
// FUNÇÃO CORRIGIDA - Lógica de resize automático foi removida
// ==================================================================
function resize() {
    // A função que adicionava a classe 'semi-nav' automaticamente foi removida
    // para prevenir a quebra de layout. O controle agora é 100% manual pelo clique no ícone do header.
}
$(function () {
    resize();
});
...
// >>-- 07 Loader JS (CORRIGIDO) --<<
$('.loader-wrapper').fadeOut(0, function () { // MUDADO DE 'slow' PARA 0 (instantâneo)
  $(this).remove();
});
